...
class CommandInterceptorExecutionTest {
    ...
    void globalInterceptorCanStopExecutionBeforeBinding() {
        ...
        assertEquals(Collections.emptyList(), sender.getMessages());
    }
    ...
    void annotationInterceptorCanStopDirectCommandExecution() {
        ...
        dispatcher.dispatch(context, compileRoot(handler, dependencyManager), senderHandleFor(sender), "admin", new String[]{"blocked"});
    ...
    void annotationInterceptorCanStopDefaultAndUnknownHandlers() {
        ...
        dispatcher.dispatch(context, root, senderHandleFor(sender), "admin", new String[0]);
        dispatcher.dispatch(context, root, senderHandleFor(sender), "admin", new String[]{"missing"});
    ...
    void nearestScopeWinsForTypeAndMethodInterceptorAnnotations() {
        ...
        dispatcher.dispatch(context, root, senderHandleFor(sender), "admin", new String[]{"ping"});
        dispatcher.dispatch(context, root, senderHandleFor(sender), "admin", new String[]{"coin", "status"});
        dispatcher.dispatch(context, root, senderHandleFor(sender), "admin", new String[]{"coin", "set"});
    ...
    void differentAnnotationInterceptorsComposeOnOneCommand() {
        ...
        dispatcher.dispatch(context, compileRoot(new ComposedAnnotationCommands(), dependencyManager), senderHandleFor(sender), "admin", new String[]{"run"});
    ...
    void sameAnnotationInterceptorBeanCanRunForDifferentMatchedAnnotations() {
        ...
        dispatcher.dispatch(context, compileRoot(new SharedAnnotationCommands(), dependencyManager), senderHandleFor(sender), "admin", new String[]{"run"});
    ...
    void beforeRunsForwardAndAfterRunsInReverseOrder() {
        ...
        dispatcher.dispatch(context, compileRoot(new LifecycleCommands(), dependencyManager), senderHandleFor(sender), "admin", new String[]{"ok"});
    ...
    void errorsRunInReverseOrderAcrossMergedInterceptorChain() {
        ...
        dispatcher.dispatch(context, compileRoot(new LifecycleCommands(), dependencyManager), senderHandleFor(sender), "admin", new String[]{"fail"});
