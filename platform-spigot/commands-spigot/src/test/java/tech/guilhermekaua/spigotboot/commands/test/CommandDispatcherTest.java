...
class CommandDispatcherTest {
    ...
    void dispatchesNestedStaticCommandGroupUsingRootAndRouteAliases() {
        ...
        dispatcher.dispatch(context, root, sender, "adm", new String[]{"coins", "Alex", "give", "5"});
    ...
    void dispatchesNestedDefaultCommandAtExactPrefix() {
        ...
        dispatcher.dispatch(context, root, sender, "admin", new String[]{"coin"});
    ...
    void dispatchesNonStaticInnerCommandGroup() {
        ...
        dispatcher.dispatch(context, root, sender, "admin", new String[]{"profile", "Kai"});
    ...
    void dispatchesNestedCommandGroupWithConstructorAndFieldInjection() {
        ...
        dispatcher.dispatch(context, root, sender, "admin", new String[]{"audit", "Sam"});
    ...
    static class NestedAliasCommands {
        ...
        public static class CoinCommands {
            ...
            public void update(@Sender CommandSender sender, String player, Integer amount, CommandExecutionContext context) {
